...
class OnlPlatform_x86_64_accton_as5915_16x_r0(OnlPlatformAccton,
                                              OnlPlatformPortConfig_6x10_8x1_4x1):
    PLATFORM='x86-64-accton-as5915-16x-r0'
    MODEL="AS5915-16X"
    SYS_OBJECT_ID=".5915.16"
    ...
    def baseconfig(self):
        ...
        for m in [ 'fpga', 'cpld', 'sys', 'leds' , 'psu' ]:
            self.insmod("x86-64-accton-as5915-16x-%s" % m)
        ...
        for port in range(5, 13):
            self.new_i2c_device('optoe2', 0x50, port+13)
        ...
        self.new_i2c_devices(
            [
                ...
                # initialize CPLD
                ('as5915_16x_fpga', 0x64, 31), # i2c 42-45
                ('as5915_16x_cpld', 0x63, 32),

                # initiate PSU eeprom
                ('as5915_16x_psu', 0x50, 36),
