...
#include "x86_64_accton_as5915_16x_int.h"
...
onlp_sfpi_presence_bitmap_get(onlp_sfp_bitmap_t* dst)
{
    ...
    /* ignor bit 0, 1 since port 0 is mapped to bit 2 of low byte register value */
    presence_all = presence_all >> 2;
    /* Populate bitmap */
