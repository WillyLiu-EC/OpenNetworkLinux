...
static onlp_thermal_info_t linfo[] = {
    ...
    { { ONLP_THERMAL_ID_CREATE(THERMAL_11_ON_MAIN_BROAD), "max6658-i2c-9-4c Tofino Fan Ctrl", 0}, 
            ONLP_THERMAL_STATUS_PRESENT,
            ONLP_THERMAL_CAPS_ALL, 0, {72000, 76000, 80000}
    },
